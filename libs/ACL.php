...
class ACL
{
	...
	public static $role_pages = array(
			'admin' =>
						array(
							'keuangan' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'user' => array('list','view','accountedit','accountview','add','edit', 'editfield','delete','import_data'),
							'dana_masuk' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'dana_keluar' => array('list','view','add','edit', 'editfield','delete','import_data'),
			...
			'user' =>
						array(
							'keuangan' => array('list'),
							'dana_masuk' => array('list','view','add','delete'),
							'dana_keluar' => array('list','view','add','delete')
						),
		
			'kepsek' =>
						array(
							'keuangan' => array('list'),
							'dana_masuk' => array('list'),
							'dana_keluar' => array('list')
						)
		);
